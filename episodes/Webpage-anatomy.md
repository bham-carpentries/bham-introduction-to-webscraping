...
We’ll start by exploring what HTML (Hypertext Markup Language) is and how it uses tags to organise and format content.
...
- Slide - where HTML fits in
    - even if using semi-automated tools still need to work out what to extract
- HTML - uses tags to organise and format content.

- Slide - ask what people think it will do
  - Show file in editor
  - open file from folder - opens in browser
  - show address in browser is local folder location
  
- Slides showing tags etc
...
Finally, we can define or modify the behaviour, appearance, or functionality of an element using **attributes**.
...
- Slide - overall structure of page
